          ...
          Column(
            children: <Widget>[
              ...
              Stack(
                  ...
                  children: <Widget>[
                    _ButterFlyAssetVideo(),
                    Image.asset('images/icon_location_200.png'),
                  ]),
            ],
          ),
        ])),
...
class _ButterFlyAssetVideoState extends State<_ButterFlyAssetVideo> {
  ...
  void initState() {
    ...
    // http://192.168.57.1:8888/static/video/bee.mp4
    _controller = VideoPlayerController.network(
        "http://192.168.57.1:8888/static/bgm/11.mp3");
...
//     _videoPlayerController = VideoPlayerController.asset('assets/bee.mp4');
